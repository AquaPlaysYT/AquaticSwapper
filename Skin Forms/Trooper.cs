...
{
    public partial class Trooper : MetroForm
    {
        public Trooper()
        {
            InitializeComponent();
        ...
        {
            047, 071, 097, 109, 101, 047, 067, 104, 097, 114, 097, 099, 116, 101, 114, 115, 047, 080, 108, 097, 121, 101, 114, 047, 077, 097, 108, 101, 047, 077, 101, 100, 105, 117, 109, 047, 066, 111, 100, 105, 101, 115, 047, 077, 095, 077, 101, 100, 095, 083, 111, 108, 100, 105, 101, 114, 095, 048, 052, 047, 083, 107, 105, 110, 115, 047, 066, 082, 095, 048, 049, 047, 077, 097, 116, 101, 114, 105, 097, 108, 047, 077, 095, 077, 069, 068, 095, 083, 111, 108, 100, 105, 101, 114, 095, 048, 052, 095, 065, 083, 078, 095, 066, 082, 048, 049, 046, 077, 095, 077, 069, 068, 095, 083, 111, 108, 100, 105, 101, 114, 095, 048, 052, 095, 065, 083, 078, 095, 066, 082, 048, 049
        };

        private static byte[] body2 = new byte[]
        {
            047, 071, 097, 109, 101, 047, 067, 104, 097, 114, 097, 099, 116, 101, 114, 115, 047, 080, 108, 097, 121, 101, 114, 047, 077, 097, 108, 101, 047, 077, 101, 100, 105, 117, 109, 047, 066, 111, 100, 105, 101, 115, 047, 077, 095, 077, 101, 100, 095, 083, 111, 108, 100, 105, 101, 114, 095, 048, 052, 047, 083, 107, 105, 110, 115, 047, 067, 086, 095, 048, 054, 047, 077, 097, 116, 101, 114, 105, 097, 108, 115, 047, 077, 095, 077, 101, 100, 095, 083, 111, 108, 100, 105, 101, 114, 095, 048, 052, 095, 067, 086, 048, 054, 046, 077, 095, 077, 101, 100, 095, 083, 111, 108, 100, 105, 101, 114, 095, 048, 052, 095, 067, 086, 048, 054, 000, 000, 000, 000, 000, 000, 000
        };


        private static void ReplaceByte3()
        {
            ReplaceBytes(Properties.Settings.Default.pakFiles + "\\pakchunk10_s1-WindowsClient.pak", 1544623146L, body1);
        }

        private static void RevertByte4()
        {
            ReplaceBytes(Properties.Settings.Default.pakFiles + "\\pakchunk10_s1-WindowsClient.pak", 1544623146L, body2);
        }
